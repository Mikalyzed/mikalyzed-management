...
import { isR2Configured, createMultipart } from '@/lib/r2'

/**
 * POST /api/upload-links/[token]/multipart/start
 * Body: { contentType, fileName }
 * Returns: { uploadId, key }
 *
 * Creates an R2 multipart upload session. Browser then uploads parts via the
 * sign-part endpoint and finalizes with /complete.
 */
